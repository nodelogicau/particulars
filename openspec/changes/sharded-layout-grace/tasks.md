...
- [ ] 3.3 Comment on and close #29: grace period accepted with the count check and the hardened validator; the arrival-keyed alternative considered and why rejected; the clock rules deleted and `object-identifiers` reverted as proposed; the dogfood evidence (one of thirty-seven PRs crossed a boundary; #39 is the scenario)
...
- [ ] 3.5 Record in particulars-knowledge: a claim recording the grace period and why the three clock changes were answers to the wrong question, qualifying the third and fourth claims of #39
